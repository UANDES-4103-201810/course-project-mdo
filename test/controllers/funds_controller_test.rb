...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference('Fund.count') do
      post funds_url, params: { fund: { approved: @fund.approved, money: @fund.money, project_id: @fund.project_id, user_id: @fund.user_id } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { approved: @fund.approved, money: @fund.money, project_id: @fund.project_id, user_id: @fund.user_id } }
