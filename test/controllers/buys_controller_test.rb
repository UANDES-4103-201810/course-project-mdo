...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post buys_url, params: { buy: { approved: @buy.approved, promise_id: @buy.promise_id, user_id: @buy.user_id } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { approved: @buy.approved, promise_id: @buy.promise_id, user_id: @buy.user_id } }
