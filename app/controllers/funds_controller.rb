class FundsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fund.save
        UserMailer.with(user: current_user, project: Project.find(@fund.project_id), id: @fund.id).fund_project.deliver_later
  ...
  private
    ...
    def fund_params
      params.require(:fund).permit(:money, :approved, :project_id, :user_id)
    end
end
